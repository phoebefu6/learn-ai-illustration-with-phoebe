/* learn-ai-illustration-with-phoebe - shared page behavior
...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    if (m) {
      ...
      var pages = ["01-where-control-lives.html", "02-style-dna-written-down.html", "03-composition-and-the-type-zone.html", "04-the-lettering-law.html", "05-consistency-is-a-pipeline.html", "06-when-it-earns-its-place.html"];
...
(function () {
  "use strict";
  var PASSPORT_KEY = "lwp-passport:ai-illustration";

...
(function () {
  ...
  var C_ACCENT = theme("--indigo", "#C2492F");        // session fill + trunk
  var C_DEEP   = theme("--indigo-deep", "#352B6B");   // root fill
  var C_SOFT   = theme("--indigo-soft", "#CBC5E8");   // concept border
  var C_TINT   = theme("--indigo-50", "#EFECF8");     // concept fill
  var C_INK    = theme("--ink", "#1F1B33");           // concept text
  var C_FAINT  = theme("--faint", "#D6D2E6");         // twig edges
